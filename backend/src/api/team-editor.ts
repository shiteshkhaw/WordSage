...
teamEditorRouter.post('/:teamId/documents/:docId/versions', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
...
// List versions
teamEditorRouter.get('/:teamId/documents/:docId/versions', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
teamEditorRouter.get('/:teamId/documents/:docId/versions/:versionId', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// List comments
teamEditorRouter.get('/:teamId/documents/:docId/comments', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Add comment
teamEditorRouter.post('/:teamId/documents/:docId/comments', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
teamEditorRouter.put('/:teamId/documents/:docId/comments/:commentId', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Delete comment
teamEditorRouter.delete('/:teamId/documents/:docId/comments/:commentId', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Get approval status
teamEditorRouter.get('/:teamId/documents/:docId/approval', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Submit for review
teamEditorRouter.post('/:teamId/documents/:docId/submit-review', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Approve document
teamEditorRouter.post('/:teamId/documents/:docId/approve', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
// Reject document
teamEditorRouter.post('/:teamId/documents/:docId/reject', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
teamEditorRouter.post('/:teamId/documents/:docId/presence', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
teamEditorRouter.get('/:teamId/documents/:docId/presence', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
teamEditorRouter.get('/:teamId/documents/:docId/export', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
    try {
        if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
