...
teamsRouter.post('/', requireAuth, async (req, res) => {
    ...
    try {
        ...
        prisma.team_style_guides.create({
            ...
            .catch((err) => console.log('⚠️ Style guide error:', err.message));
        return res.json({
            success: true,
            team,
        });
...
teamsRouter.get('/invites', requireAuth, async (req, res) => {
...
teamsRouter.get('/:teamId', requireAuth, async (req, res) => {
    ...
    try {
        ...
        const ownerInMembers = formattedMembers.find((m) => m.user_id === team.owner_id);
        if (!ownerInMembers) {
...
teamsRouter.post('/:teamId/invite', requireAuth, async (req, res) => {
    ...
    try {
        ...
        // Send invite email
        try {
            await sendTeamInviteEmail(invitedUser.email, inviterProfile?.full_name || inviterProfile?.email || "A teammate", team.name, acceptUrl, rejectUrl);
...
teamsRouter.post('/:teamId/accept', requireAuth, async (req, res) => {
...
teamsRouter.post('/:teamId/reject', requireAuth, async (req, res) => {
...
teamsRouter.get('/:teamId/members', requireAuth, async (req, res) => {
...
teamsRouter.put('/:teamId/style-guide', requireAuth, async (req, res) => {
...
teamsRouter.get('/:teamId/content-library', requireAuth, async (req, res) => {
...
teamsRouter.delete('/:teamId', requireAuth, async (req, res) => {
    try {
        const { teamId } = req.params;
...
teamsRouter.post('/:id/accept', requireAuth, async (req, res) => {
    try {
...
teamsRouter.post('/:id/reject', requireAuth, async (req, res) => {
    try {
        const teamId = req.params.id;
...
teamsRouter.patch('/:teamId/members/:memberId/role', requireAuth, async (req, res) => {
    try {
...
teamsRouter.delete('/:teamId/members/:memberId', requireAuth, async (req, res) => {
...
teamsRouter.patch('/:teamId/members/:memberId/ownership', requireAuth, async (req, res) => {
    try {
        const { teamId, memberId } = req.params;
        const userId = req.user?.id;
        const team = await prisma.teams.findUnique({
...
teamsRouter.get('/check-user/:email', requireAuth, async (req, res) => {
    try {
        if (!req.user)
            return res.status(401).json({ error: 'Unauthorized' });
...
teamsRouter.get('/:teamId/role', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
...
teamsRouter.get('/:teamId/content', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
...
teamsRouter.post('/:teamId/content', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
...
teamsRouter.put('/:teamId/content/:itemId', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
...
teamsRouter.delete('/:teamId/content/:itemId', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
...
teamsRouter.post('/:teamId/content/:itemId/use', requireAuth, async (req, res) => {
    try {
        const { itemId } = req.params;
...
teamsRouter.get('/:teamId/style-guide', requireAuth, async (req, res) => {
    try {
        if (!req.user) {
            return res.status(401).json({ error: 'Unauthorized' });
        }
        ...
        res.json({
            data: {
                styleGuide: {
                    ...styleGuide,
                    updater_email: styleGuide.updater?.email,
                },
                userRole,
            },
        });
