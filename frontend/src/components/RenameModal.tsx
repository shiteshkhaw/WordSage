  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl animate-scaleIn">
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Rename Document</h2>
        <p className="text-slate-600 mb-6 text-sm">Choose a new name for your document</p>
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            disabled={!documentName.trim() || documentName.trim() === currentName}
